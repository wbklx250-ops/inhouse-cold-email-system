...
# ---------------------------------------------------------------------------
class SmartleadOAuthUploader(MicrosoftSequencerOAuthUploader):
    """Smartlead-specific URL markers + screenshot prefix."""

    def __init__(self, headless: bool = True, worker_id: int = 0):
        super().__init__(
            headless=headless,
            worker_id=worker_id,
            success_url_markers=("smartlead", "server.smartlead"),
            screenshot_prefix="sl",
        )
