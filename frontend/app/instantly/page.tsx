  ...
  const fetchBatches = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Fix: Handle both flat array and object with batches property
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Automatically upload mailboxes from your setup batches to your email sequencer (Instantly.ai or Smartlead.ai) using OAuth automation.
          </p>
        </div>
